...
#predictions_cv <- pmax(predictions_cv, 0)
...
```{r}
algoritmos <- c("KNN", "Regresión Lineal")

# MSE
mse_group <- c(mse_knn, mse_lm)
barplot(mse_group, names.arg = algoritmos, col = c("blue", "green", "orange"),
        main = "Comparación de MSE",
        ylab = "Valores",
        ylim = c(0, max(mse_group) * 1.2))  # Ajustar el límite y para mayor claridad
...
# R²
r_squared_group <- c(r_squared_knn, r_squared_lm)
barplot(r_squared_group, names.arg = algoritmos, col = c("blue", "green", "orange"),
        main = "Comparación de R²",
        ylab = "Valores",
        ylim = c(0, max(r_squared_group) * 1.2))  # Ajustar el límite y para mayor claridad
...
# MAE
mae_group <- c(mae_knn, mae_lm)
barplot(mae_group, names.arg = algoritmos, col = c("blue", "green", "orange"),
        main = "Comparación de MAE",
        ylab = "Valores",
        ylim = c(0, max(mae_group) * 1.2))  # Ajustar el límite y para mayor claridad
